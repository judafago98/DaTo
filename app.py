...
st.markdown("""
    <style>
        ...
        .stApp {
            ...
            background-image: radial-gradient(circle at top right, rgba(0, 102, 255, 0.15), transparent 40%),
                              radial-gradient(circle at bottom left, rgba(0, 198, 255, 0.1), transparent 40%);
