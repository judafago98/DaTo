...
# ==========================================
    ...
    if menu_seleccionado == "inicio":
        ...
        with tab_bi:
            st.markdown("<br>", unsafe_allow_html=True)
            st.markdown(f"""
            <div style="background: linear-gradient(135deg, rgba(0,198,255,0.05) 0%, rgba(0,102,255,0.15) 100%); border: 1px solid rgba(0, 198, 255, 0.4); border-radius: 20px; padding: 30px; text-align: center; box-shadow: 0 10px 30px rgba(0,198,255,0.1); margin-bottom: 25px;">
        ...
        with tab_eficiencia:
            ...
            st.markdown(f"""
            <div style="background: rgba(4, 13, 30, 0.6); backdrop-filter: blur(10px); border: 1px solid rgba(0, 198, 255, 0.15); border-radius: 16px; padding: 25px; margin-top: 20px; text-align: center;">
