...
try:
    ...
    # ==========================================
        ...
        if menu_seleccionado == "inicio":
            ...
            g_socios = float(auditoria['g_socios']) # ¡AQUÍ YA ESTÁN LOS 37M DE DAVID Y LOS DEL FONDO!
