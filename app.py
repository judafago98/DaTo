...
# --- DISEÑO ULTRA PREMIUM Y RESPONSIVO ---
st.markdown("""
    <style>
        ...
        .stButton>button {
            background: linear-gradient(135deg, #0066FF 0%, #00C6FF 100%); width: 100% !important;
...
try:
    ...
    # === SEGURO ANTI-FUGAS DE MEMORIA: Se ejecuta SIEMPRE, incluso si Streamlit reinicia ===
    try:
